    ...
    try {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Updates could not be refreshed. Try again.'),
          ),
        );
      }
    }
                ...
                sliver: SliverList.list(
                  children: [
                    ...
                    _PrimaryActions(
                      ...
                      onFamilyPocket: () => Navigator.pushNamed(
                        context,
      ...
      children: [
        ...
        Semantics(
          ...
          child: const CircleAvatar(
            radius: 23,
            backgroundColor: Color(0xFFD7F6F3),
            child: Icon(
        ...
        child: Ink(
          ...
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(
              ...
              colors: [Color(0xFF09A99F), Color(0xFF006A6A)],
            ),
            boxShadow: const [
              BoxShadow(
                color: Color(0x2B007A76),
                blurRadius: 18,
                offset: Offset(0, 8),
              ),
            ],
              ...
              TextButton.icon(
                onPressed: () => Navigator.of(context).push(
                  MaterialPageRoute<void>(
                    builder: (_) =>
                        CoverageDetailsScreen(balanceKobo: balanceKobo),
                  ),
                ),
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 13,
                  fontWeight: FontWeight.w800,
                  color: balanceKobo >= guide.referenceCost * 100
                      ? AppColors.success
    ...
    children: [
      ...
      Expanded(
        child: _ActionButton(
          ...
          onTap: () => Navigator.pushNamed(context, AppRoute.findCare.path),
        ),
      ),
      const SizedBox(width: 12),
      Expanded(
    ...
    children: [
      Row(
        children: [
          ...
          TextButton(
            onPressed: () =>
                Navigator.pushNamed(context, AppRoute.activity.path),
        ...
        ...store.contributions
            ...
            .map(
              (activity) => _ActivityTile(
                amountKobo: activity.amountKobo,
...
class _EmptyActivity extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(
      children: [
        Image.asset(
          'assets/activity/no-activity.png',
          height: 104,
          fit: BoxFit.contain,
        ),
        const Text(
...
String _formatKobo(int amountKobo) {
  ...
  return kobo == 0
      ? _formatNaira(naira)
      : '${_formatNaira(naira)}.${kobo.toString().padLeft(2, '0')}';
}
